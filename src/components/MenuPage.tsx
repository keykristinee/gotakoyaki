...
export default function MenuPage() {
  const menuItems = [
    ...
    },
    {
      ...
      image: '/products/ebiyakiwithquailegg16.png',
      isBestSeller: true,
    },
    {
      id: 5,
      ...
      image: '/products/babyoctopus16.png',
      isBestSeller: true,
    },
     {
      id: 6,
